...
<html>
<head>
<title>Cálculo de grado de consanguineidad/afinidad</title>
...
<div class="body">
	<form>
		<h1>Cálculo de grado de consanguineidad/afinidad</h1>
		<p>
		...
		<p>
			<button type="submit" name="operation" value="calculate">calcular grados</button>
			<button type="submit" name="operation" value="vocabulary">ver vocabulario de términos admitidos</button>
		</p>
	</form>
...
<xsl:template match="result">
	<ul class="result">
		<li>grado de consanguineidad:<xsl:value-of select="kinship-degree"/></li>
		<li>grado de afinidad:<xsl:value-of select="affinity-degree"/></li>
	</ul>
</xsl:template>
